...
export default function SoporteScreen() {
    ...
    const abrirWhatsApp = () => {
        Linking.openURL('https://wa.me/50768014613?text=Hola, estoy usando Vesta Market y tengo una duda');
    };

    const abrirEmail = () => {
        Linking.openURL('mailto:adp21900@gmail.com?subject=Soporte Vesta Market');
    };
            ...
            <View style={styles.content}>
                <Animated.View entering={FadeInUp.delay(200)} style={styles.heroSection}>
                    ...
                    <Text style={[styles.subtitle, { color: colors.textSecondary }]}>
                        Nuestro equipo está listo para ayudarte con cualquier duda técnica sobre Vesta Market.
                    </Text>
                </Animated.View>
                ...
                <Animated.View entering={FadeInDown.delay(400)} style={styles.optionsContainer}>
                    ...
                    >
                        ...
                        <View style={styles.optionInfo}>
                            ...
                            <Text style={[styles.optionDesc, { color: colors.textMuted }]}>Documentación legal de Vesta Market</Text>
                        </View>
                        <Ionicons name="chevron-forward" size={20} color={colors.textMuted} />
                    </TouchableOpacity>
                </Animated.View>
                ...
                <View style={styles.footer}>
                    <Text style={[styles.footerText, { color: colors.textMuted }]}>Vesta Market v1.0.4 - Premium Support</Text>
                </View>
            </View>
        </View>
    );
