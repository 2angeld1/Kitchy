...
export const exportComisionesPdf = async (data: any, periodo: string, businessName: string = 'Vesta Market Beauty', ventas: any[] = []) => {
    try {
        ...
        <body>
            ...
            <div class="footer">
                Reporte detallado generado por el sistema Vesta Market POS.
            </div>
        </body>
        </html>
        `;
...
export const exportReporteEspecialistaPdf = async (espData: any, periodo: string, businessName: string = 'Vesta Market Beauty') => {
    try {
        ...
        <body>
            ...
            <div class="footer">
                Este es un comprobante de pago generado por <strong>Vesta Market POS</strong>.
            </div>
        </body>
        </html>
        `;
