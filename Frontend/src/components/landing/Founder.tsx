  ...
  <section id="founder" className="py-32 relative overflow-hidden bg-zinc-950/20">
    <div className="container mx-auto px-6">
      <div className="glass border border-white/5 rounded-[60px] p-12 md:p-20 relative overflow-hidden">
        <div className="absolute top-0 right-0 w-96 h-96 bg-emerald-600/10 blur-[150px] rounded-full -translate-y-1/2 translate-x-1/2" />
        
        <div className="flex flex-col lg:flex-row items-center gap-16 relative z-10">
          <div className="w-64 h-64 md:w-80 md:h-80 shrink-0 relative">
             <div className="absolute inset-0 border-2 border-emerald-500 rounded-[60px] translate-x-4 translate-y-4" />
          ...
          <div className="flex-1 text-center lg:text-left">
            ...
            <h3 className="text-5xl md:text-7xl font-black text-white uppercase italic tracking-tighter mb-4">
              Angel <span className="text-emerald-600 not-italic">Fernandez</span>
            </h3>
            <p className="text-emerald-500 font-black text-sm uppercase tracking-widest mb-10">Founder & Lead Engineer — Gosen Tech</p>
            
            <p className="text-zinc-400 text-xl md:text-2xl font-medium italic leading-relaxed mb-12 max-w-2xl">
              "Innovación local con visión global: Vesta es la prueba de que el talento panameño no tiene fronteras."
            </p>
            ...
            <a 
              ...
              target="_blank" 
              className="inline-flex items-center gap-3 bg-white text-black px-10 py-5 rounded-2xl font-black text-xs uppercase tracking-widest hover:bg-emerald-600 hover:text-white transition-all shadow-xl shadow-white/5 hover:shadow-emerald-600/20"
            >
