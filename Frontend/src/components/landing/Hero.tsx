...
export const Hero = () => (
  <section id="inicio" className="relative min-h-screen flex items-center pt-24 overflow-hidden">
    ...
    <div className="absolute top-20 left-10 w-96 h-96 bg-emerald-600/10 blur-[150px] rounded-full pointer-events-none" />
    ...
    <div className="container mx-auto px-6 h-full flex flex-col md:flex-row items-center justify-between gap-12">
      ...
      >
        ...
        <div className="absolute -top-32 -left-20 pointer-events-none hidden lg:block opacity-20">
          ...
          <div className="w-32 h-32 bg-emerald-900/40 rotate-[15deg] rounded-3xl border border-emerald-500/10 absolute top-20 left-10" />
        </div>
        <div className="inline-block px-3 py-1.5 rounded-xl glass border border-emerald-500/20 mb-6">
          <span className="text-emerald-500 text-[10px] font-black tracking-[3px] uppercase">POS inteligente para cada tipo de negocio</span>
        </div>
        ...
        <h1 className="text-3xl md:text-5xl font-black tracking-tight leading-[1.1] mb-5 text-white uppercase italic pt-2 px-1 relative inline-block">
          ¡Tu <span className="text-emerald-600 not-italic">solución</span><br />
          para <span className="text-gradient pr-2">no perder</span><br />
          dinero!
          <div className="absolute -right-10 top-1/2 -translate-y-1/2 w-8 h-8 bg-emerald-600/20 rounded-full blur-xl animate-pulse" />
        </h1>

        <p className="text-zinc-500 text-[11px] md:text-[13px] leading-relaxed max-w-sm mb-10 font-medium opacity-70">
          Toma el control absoluto de tus ventas, mermas e inventarios. Vesta es la inteligencia que tu negocio necesita para ser rentable.
        </p>
        ...
        <div className="flex flex-col sm:flex-row gap-6 relative">
          <a 
            ...
            className="bg-emerald-600 hover:bg-emerald-700 text-white px-10 py-5 rounded-3xl font-black text-lg flex items-center justify-center gap-3 transition-all glow-primary h-16 group z-10"
          >
          ...
          <div className="absolute -bottom-20 -left-40 w-[400px] h-[400px] rounded-full border border-emerald-500/5 pointer-events-none hidden md:block" />
        </div>
      </motion.div>
      ...
      >
        <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
          ...
          <div className="absolute w-[300px] h-[300px] md:w-[450px] md:h-[450px] bg-emerald-600/20 rounded-full blur-[100px] animate-pulse" />

          {/* 2. Rotating Neon Arc */}
          <motion.div
            animate={{ rotate: 360 }}
            transition={{ duration: 15, repeat: Infinity, ease: "linear" }}
            className="absolute w-[320px] h-[320px] md:w-[460px] md:h-[460px] rounded-full shadow-[0_0_50px_-12px_rgba(225,29,72,0.3)] border-t border-emerald-500/40"
          />
          ...
          <motion.div
            ...
            className="absolute w-[290px] h-[290px] md:w-[420px] md:h-[420px] rounded-full border border-emerald-500/40 border-dotted"
          />
          ...
          <motion.div
            ...
            className="absolute w-[380px] h-[380px] md:w-[540px] md:h-[540px] rounded-full border border-emerald-500/20 border-dotted"
          />
        </div>
        ...
        <div className="absolute inset-0 pointer-events-none">
          ...
          >
            <BarChart3 className="text-emerald-500 w-6 h-6 md:w-8 md:h-8" />
          </motion.div>
          ...
          >
            <Zap className="text-emerald-500 w-4 h-4 md:w-6 md:h-6" />
          </motion.div>
        </div>
