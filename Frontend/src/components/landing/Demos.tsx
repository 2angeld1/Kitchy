    ...
    <section id="demos" className="py-32 relative overflow-hidden bg-zinc-950/20">
      <div className="container mx-auto px-6">
        <div className="text-center mb-20">
          <h2 className="text-5xl md:text-7xl font-black mb-6 uppercase italic tracking-tighter">
             VESTA EN <span className="text-emerald-600 not-italic">ACCIÓN</span>
          </h2>
        ...
        <div className="flex flex-col gap-8">
          ...
          <div className="grid lg:grid-cols-3 gap-8 items-start">
            ...
            >
              <div className="relative h-full rounded-[60px] overflow-hidden border border-zinc-800 bg-black shadow-2xl group-hover:border-emerald-500/50 transition-all">
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-transparent to-transparent flex flex-col justify-end p-10">
                  <span className="text-emerald-500 text-[10px] font-black uppercase tracking-[5px] mb-2">Sistema Central</span>
            ...
            >
              <div className="relative h-full rounded-[60px] overflow-hidden border border-zinc-800 bg-black shadow-2xl group-hover:border-emerald-500/50 transition-all">
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-transparent to-transparent flex flex-col justify-end p-10">
                  <div className="px-4 py-1.5 bg-emerald-600 rounded-full text-[10px] font-black tracking-widest uppercase mb-4 inline-block w-fit">
      ...
      <AnimatePresence>
        {selectedVideo && (
          ...
          >
            <button className="absolute top-10 right-10 text-white hover:text-emerald-500 transition-colors z-[110]">
