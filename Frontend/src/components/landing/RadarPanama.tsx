      ...
      <div className="flex flex-col lg:flex-row items-center gap-20">
        <div className="flex-1">
          ...
          <h2 className="text-5xl md:text-7xl font-black mb-8 uppercase italic tracking-tighter leading-[0.9] text-white">
            EL RADAR DE <span className="text-emerald-600 not-italic">PANAMÁ</span>
          </h2>
        ...
        <div className="flex-1 relative">
          <div className="absolute inset-0 bg-emerald-600/20 blur-[120px] rounded-full" />
            ...
            <div className="space-y-8">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="p-4 rounded-2xl bg-zinc-900 border border-white/5">
                  ...
                  <p className="text-xl font-black text-white">$1.02 <span className="text-xs text-emerald-500">↑</span></p>
                </div>
                <div className="p-4 rounded-2xl bg-zinc-900 border border-white/5">
