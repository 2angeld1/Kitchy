...
export const UserItemCard: React.FC<Props> = ({
    ...
    const renderRightActions = () => (
        <View style={{ flexDirection: 'row', alignItems: 'center', height: '100%' }}>
            ...
            {!isProtected && (
                <TouchableOpacity
                    style={{ backgroundColor: `${colors.error}1A`, width: 60, height: '100%', justifyContent: 'center', alignItems: 'center', borderRadius: 16, borderWidth: 1, borderColor: `${colors.error}33` }}
