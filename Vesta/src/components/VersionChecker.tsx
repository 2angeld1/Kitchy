...
export const CURRENT_CLIENT_VERSION = process.env.EXPO_PUBLIC_APP_VERSION || '1.0.0';
    ...
    return (
        ...
        >
            <View style={{ 
                ...
                <View style={{ flex: 1 }}>
                    <Text style={{ fontSize: 15, fontWeight: '900', color: '#fff', marginBottom: 2 }}>Nueva versión de Vesta</Text>
