...
import { formatMoney, getInventoryIcon } from '../../../../shared/utils/beauty-helpers';
...
export const InventarioItemCard: React.FC<Props> = ({
    ...
    const renderRightActions = () => (
        <View style={{ flexDirection: 'row', alignItems: 'center' }}>
            ...
            <TouchableOpacity style={[styles.rightAction, { backgroundColor: `${colors.error}1A` }]} onPress={() => onDelete(item._id)}>
