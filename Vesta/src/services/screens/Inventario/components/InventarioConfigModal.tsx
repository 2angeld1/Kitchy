...
export const InventarioConfigModal: React.FC<Props> = ({
    ...
    const title = 'Comisión de Reventa';
    const description = 'Establece el % global que ganarán los especialistas por la venta de productos de reventa.';
    const icon = 'cash-outline';
