...
import { updateNegocioConfig, updateComisionReventaConfig } from '../../shared/services/api';
        ...
        <View style={styles.container}>
            ...
            <Text style={[styles.smartHint, { color: isListening ? colors.primary : colors.textMuted }]}>
                {isListening
                    ...
                    : '💡 Escribe o dicta: "5 tintes a 10 dólares" o "usé 1 pote de cera"'}
            </Text>

            {/* FILTROS RÁPIDOS - FLEX LAYOUT */}
            <View style={styles.filterContainer}>
                <View style={styles.filterOptions}>
                    {['todos', 'stockBajo', 'reventa', 'insumo', 'limpieza'].map(opcion => {
