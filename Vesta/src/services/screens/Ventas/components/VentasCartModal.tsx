...
import { getBeautyIcon } from '../../../../shared/utils/beauty-helpers';
                                    ...
                                    {!isLandscape && (
                                        <View style={styles.cartItemImage}>
                                            {item.producto.imagen ? (
                                                ...
                                                <Ionicons
                                                    name={(item.producto.categoria === 'reventa' ? 'sparkles-outline' : getBeautyIcon(item.producto.nombre) + '-outline') as any}
                                                    size={24}
