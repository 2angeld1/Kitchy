...
import { getInventario, createInventario, updateInventario, deleteInventario, registrarEntrada, registrarSalida, registrarMerma, importarInventario, lookupProducto, procesarFacturaCaitlyn, procesarLoteInventario } from '../../shared/services/api';
...
export const useInventario = () => {
    ...
    useEffect(() => {
        if (!editItem) setCategoria('insumo');
    }, [editItem]);
    ...
    }, [costoUnitario, user, comisionEspecialista]);
